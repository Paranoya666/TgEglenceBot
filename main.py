...
def button():
	BUTTON=[[InlineKeyboardButton(text="👨🏻‍💻 Sahibim ",url="t.me/xXx_KABUS")]]
	BUTTON+=[[InlineKeyboardButton(text="🌱 RESMI 🌱",url="t.me/XXAOSresmi")]]
